...
eval_output <- query.evaluation(counts = simdata$counts,
                                ...
                                methodsNormalize = c("TMM"),
                                methodsMeanExpression = c("ROTS","limmaVoom"))
SCDE


"BPSC", "MAST", "ROTS", "DESeq2", "edgeR", "limmaVoom"

library(ggplot2)
qplot(data = eval_output$roc, x = FPR, y = TPR, geom = "path", colour = methodsMeanExpression)
```
