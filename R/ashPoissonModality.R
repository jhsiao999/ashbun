...
# uni_natural: unimodal distribution with a non-zero mode
args.uni_natural <- function(...) { list(mixcompdist = "halfuniform",
                                         mode = "estimate",
                                         prior = "uniform") }

# uni_zero: unimodal distribution with mode at zero
args.uni_zero <- function(...) { list(mixcompdist = "+uniform",
                                      mode = 0,
                                      prior = "uniform") }

# uni_natural_pm_zero: bi-modal distribution, with a non-zero mode and point mass at zero
...
# uni_natural_uni_zero: bi-modal distribution, with a non-zero mode and a mode at zero
